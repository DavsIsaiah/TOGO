 ...
 * @author Isaiah Dava
 */
public class TaskEditDB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TaskEditDB</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TaskEditDB at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TaskEditDB.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            String sql = "UPDATE Task_Assignment SET Title = '" + Title + "', TaskDesc ='" + Desc + "', DateCreate='" + dtf.format(now) + "', Deadline ='" + deadline + "', Status='" + Status + "' WHERE TaskID ='" + ID + "'";
            stmt = con.prepareStatement(sql);
            stmt.executeUpdate();
            ...
            String sql3 = "DELETE FROM Assignment WHERE TaskID ='" + ID + "'";
            ...
            sql3 = "INSERT INTO SubTasks (TaskID, Task) VALUES (?,?)";
            stmt = con.prepareStatement(sql3);
            ...
            try {
                ...
                try (PrintWriter out = response.getWriter()) {
                    /* TODO output your page here. You may use following sample code. */
                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('Succesfully Edited Task!');");
                    out.println("location='Project_Manager.jsp';");
                    out.println("</script>");
                }
                response.sendRedirect("Project_Manager.jsp");
