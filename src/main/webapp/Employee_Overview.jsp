    ...
    <body>
        ...
        <header>
            ...
            <div class="left_area">
                ...
                <h3><span>EMPLOYEE OVERVIEW</span></h3>
            </div>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                ...
                <a href="Manage_Employee.jsp"><i class="fas fa-user-friends"></i><span>Manage Employee</span></a>
            </div>
        </div>
                ...
                <tbody >
                    ...
                    <%
                        ...
                        while (rs2.next()) {
                            ...
                            stmt3.executeUpdate();
                            if (rs2.getInt("First_Time") == 0) {

                    %>
                <script>
                    alert("Employee: <%out.print(rs2.getString("name"));%> has reached 3 Flags for this month.\n\
Since he/she is a first time offender, his/her status has been set to Probation.");
                </script>
                ...
                <script>
                    alert("Employee: <%out.print(rs2.getString("name"));%> has reached 3 Flags for this month.\n\
He/She is not a first time offender, his/her status has been set to Probation.\n\
Please take necessary actions and edit the employee if he/she is Fired.");
                </script>
    ...
    <div>
        <a href="New_Employee.jsp" class="create_btn">Create New Employee</a> 
    </div>
</div>
