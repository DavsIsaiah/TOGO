    ...
    <body>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                ...
                <a href="Attendance_Late.jsp" style="background: #CCCFFF;"><i class="fas fa-user-clock"></i><span>Late</span></a>
        ...
        <div class="content">
            <div class="dropdown" style="overflow:visible;">
                ...
                <div id="myDropdown" class="dropdown-content" style="max-height:150px;overflow:scroll;">
                    ...
                    %>
                    <a href="Attendance_Late.jsp?value=<%out.print(rs.getString("date"));%>"><%out.print(rs.getString("date"));%></a>             
                    <%
                    ...
                    <%
                        try {
                            ...
                            if (ID == null) {
                                ...
                                sql2 = "select * from Emp_Info WHERE attendance ='Late'";
                            } else {
                                sql2 = "Select Emp_Info.picture, attendance.ID, Emp_Info.department, date, name, Attendance.attendance from attendance LEFT JOIN Emp_Info on attendance.ID = Emp_Info.ID WHERE date ='" + ID + "' AND attendance.attendance ='Late'";
                            }
                            boolean check = false;
                    ...
                    <tr>
                        ...
                        <td data-title="Status"><button type="button" name="fired" class="<%out.print(rs.getString("attendance"));%>"><%out.print(rs.getString("attendance"));%></button></td>
                            <%} else {
                                ...
                                String sql3 = "Select * from Attendance WHERE date ='" + ID + "' AND ID ='" + rs.getString("ID") + "' AND attendance='Late'";
