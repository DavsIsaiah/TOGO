    ...
    <body>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                ...
                <a href="Attendance_Present.jsp"><i class="fas fa-user"></i><span>Present</span></a>
                ...
                <a href="Attendance_Admin.jsp" style="background: #CCCFFF;"><i class="far fa-calendar-alt"></i><span>Daily Report</span></a>
                <a href="attendance.jsp"><i class="fas fa-user-clock"></i><span>Time In/Time out</span></a>
            </div>
        </div>
        ...
        <div class="content">
            <div class="dropdown" style="overflow:visible;">
                ...
                <div id="myDropdown" class="dropdown-content" style="max-height:150px;overflow:scroll;">
                    ...
                    %>
                    <a href="Attendance_Admin.jsp?value=<%out.print(rs.getString("date"));%>"><%out.print(rs.getString("date"));%></a>             
                    <%
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <%if (ID == null) {%>
                        <td data-title="Status"><button type="button" name="<%out.print(rs.getString("attendance"));%>" class="<%out.print(rs.getString("attendance"));%>"><%out.print(rs.getString("attendance"));%></button></td>
                            <%} else {
                                System.out.println(rs.getString("ID"));
                                String sql3 = "Select * from Attendance WHERE date ='" + ID + "' AND ID ='" + rs.getString("ID") + "'";
