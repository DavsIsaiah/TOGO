...
<html>
    <head>
        ...
        <!--sql check ilan ung subtask na naka assign tas ilipat sa input type text na index para makuha sa java script mamaya/ tapos idisplay na as li with span yung mga yun.-->
        <%
    ...
    <body>
       <!--Checking validity of session-->
        ...
        <div class="wrapper">
            ...
            <form id="myform" action="TaskEditDB?value=<%out.print(ID);%>" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
                ...
                <%
                    ...
                    try {
                        ...
                        String sql2 = "SELECT * FROM Task_Assignment WHERE TaskID='" + ID + "'";
                ...
                <div class="form">
                    <div class="inputfield">
                        ...
                        <input type="text" id="Title" name="Title" value="<%out.print(rs.getString("Title"));%>"class="input" required>
                    </div>  
                    <div class="inputfield">
                        <label for="SubTitle">Task Description</label>
                               <input type="textarea" id="SubTitle" name="SubTitle" value="<%out.print(rs.getString("TaskDesc"));
                    ...
                    <ul id="myUL">
                        <%
                            String sql = "SELECT Task FROM SubTasks WHERE TaskID = '" + ID + "'";
                            stmt = con.prepareStatement(sql);
                            rs = stmt.executeQuery();
                            while (rs.next()) {
                        %>

                        <li><%out.println(rs.getString("Task"));%><span class="close" id="<%out.print(index);%>" name="<%out.print(index);%>" title="<%out.print(rs.getString("Task"));%>">×</span></li>
                    ...
                    <br><br>
                    <input type="text" id="Index" name="Index" value="<%out.print(index);%>" class="input" hidden>	   
                    <div class="inputfield">
                        ...
                        <div class="chosen-select" >
                            <select id="assignment" name="multipleSelect" multiple required>
                                <%
                                    ...
                                    sql2 = "select ID, name from Emp_Info";
        ...
        <script>
            ...
            while (indexjava !== 0) {
                var idValue = document.getElementsByName(indexjava)[0].value;
