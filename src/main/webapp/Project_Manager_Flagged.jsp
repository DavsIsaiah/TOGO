    ...
    <body>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                ...
                <a href="Project_Manager.jsp" ><i class="fas fa-user-friends"></i><span>Manage Tasks</span></a>
                ...
                <a href="#" style="background: #CCCFFF;" ><i class="fas fa-user-friends"></i><span>Flagged</span></a>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <table class="table">
                ...
                <tbody>
                    <%
                        String sql = "SELECT * FROM Task_Assignment WHERE Status='Flagged'";
                    ...
                    <tr>
                        ...
                        <td data-title="Task Description"><button class="button" type="button" name="Open" data-toggle="modal" data-target="#<%out.print(rs.getString("TaskID"));%>" ><i id="descript_btn" class="fas fa-exclamation-circle"></i></button></td>
                                <%
                        ...
                        <td data-title="Flag Description"><button class="button" type="button" name="Open" data-toggle="modal" data-target="#<%out.print(rs.getString("TaskID") + "1");%>" ><i id="descript_btn" class="fas fa-exclamation-circle"></i></button></td>
            ...
            <div class="modal fade" id="<%out.print(rs.getString("TaskID") + "1");%>" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLongTitle"><%out.print("Reason for Flag:");%></h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <%out.println(rs.getString("Flagged"));%>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">Close</button>
