    ...
    <body>
        ...
        <div class="mobile_nav">
            ...
            <div class="mobile_nav_items">
                ...
                <a href="Attendance_Absent.jsp" style="background: #CCCFFF;"><i class="fas fa-user-minus"></i><span>Absent</span></a>
        ...
        <div class="content">
            <div class="dropdown" style="overflow:visible;">
                ...
                <div id="myDropdown" class="dropdown-content" style="max-height:150px;overflow:scroll;">
                    ...
                    %>
                    <a href="Attendance_Absent.jsp?value=<%out.print(rs.getString("date"));%>"><%out.print(rs.getString("date"));%></a>             
                    <%
                ...
                <tbody>
                    ...
                    <%
                        try {
                            ...
                            if (ID == null) {
                                sql2 = "select * from Emp_Info WHERE attendance ='Absent'";
                            } else {
                                sql2 = "Select picture, ID, department, name, 'Absent' AS Attendance from Emp_Info WHERE ID NOT IN(SELECT ID FROM Attendance WHERE Date='" + ID + "')";
                            }
                            boolean check = false;
                    ...
                    <tr>
                        ...
                        <td data-title="Status"><button type="button" name="fired" class="<%out.print(rs.getString("attendance"));%>"><%out.print(rs.getString("attendance"));%></button></td>
                            <%} else {
                                ...
                                String sql3 = "Select * from Attendance WHERE date ='" + ID + "' AND ID ='" + rs.getString("ID") + "' AND attendance='Absent'";
